...
t('parse: ranges', t => {
  ...
  is(parse('(-10..10)[]'), ['[', ['()', ['..', ['-', [INT, 10]], [INT, 10]]], undefined], 'length (20)')
})
...
t('parse: length operator', t => {
  is(parse('[a,b,c][]'), ['[', ['[]', [',', 'a', 'b', 'c']], undefined])
  is(parse('(a,b,c)[]'), ['[', ['()', [',', 'a', 'b', 'c']], undefined])
  // is(parse('"abc"[]'), ['[', ['"', "abc"]])
  is(parse('(-a..+b)[]'), ['[', ['()', ['..', ['-', 'a'], ['+', 'b']]], undefined])
})
...
t('parse: strings', t => {
  ...
  is(parse('string[]'), ['[', 'string', undefined], 'length')
...
t('parse: lists', t => {
  ...
  is(parse('list[]'), ['[', 'list', undefined], 'length')
