...
**Lino** (*li*ne *no*ise) is low-level language for sound design, processing and utilities. It has minimal C/JS-like syntax, refined language patterns (ranges, groups, stateful vars, units), static/linear memory and compiles to 0-runtime WASM. It also has smooth operator and organic sugar.
